...
<div class="container">
	<div class="row">
     ...
     <?php if($category['Category']['name'] !='Organic T-Shirts' && $category['Category']['name'] !='Women T-Shirts'
      ...
      <?php if($category['Category']['slug'] =='wooden-watches'){ ; ?>
         <div class="col-sm-6 col-xs-12">
         <h2><a href="<?php echo $this->webroot;?>category/men-watches">Men's Watches</a></h2>
         </div>
         
           <div class="col-sm-6 col-xs-12">
         <h2><a href="<?php echo $this->webroot;?>category/women-watches">Women's Watches</a></h2>
         </div>
      <?php }elseif($category['Category']['slug'] =='wooden-bracelets'){ ?>
             <div class="col-sm-6 col-xs-12">
         <h2><a href="<?php echo $this->webroot;?>category/man-bracelets">Men's Bracelets</a></h2>  
         </div>
         
           <div class="col-sm-6 col-xs-12"> 
         <h2><a href="<?php echo $this->webroot;?>category/women-bracelets">Women's Bracelets</a></h2>
         </div>
      <?php }elseif($category['Category']['slug'] =='organic-t-shirts'){ ?>
             <div class="col-sm-6 col-xs-12">
         <h2><a href="<?php echo $this->webroot;?>category/man-t-shirts">Men's T-Shirts</a></h2>  
         </div>
         
           <div class="col-sm-6 col-xs-12"> 
         <h2><a href="<?php echo $this->webroot;?>category/women-t-shirts">Women's T-Shirts</a></h2>  
         </div>
      <?php }  ?>   
         ...
         <div class="watch_txt">
         	<h2><?php echo $category['Category']['description']; ?>
                </h2>
         </div>
            ...
            <div class="col-md-3 col-sm-6 col-xs-12 portfolio-item">
                ...
                <div class="insta-portfo">
                 <div class="overlay-portfl"></div>
                   <?php echo $this->Html->Image('/images/large/' . $val1['Product']['image'], array('alt' => $val1['Product']['name'], 'class' => 'img-responsive')); ?>
                   </div>
                </a>
            </div>
           <?php endforeach;?> 
